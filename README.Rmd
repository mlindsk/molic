...
plot(m)
```
Since the observed deviance of the selected car, `r m$dev`, much larger than the critical value of `r m$cv` the car is declared an outlier. The red area represents the significance level (here $\alpha = 0.05$).
